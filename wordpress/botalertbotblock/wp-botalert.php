   ...
   <tr valign="top">
		...
		<td>
			...
			<p class="re-keys">
				...
				<input name="botalert_opt_custid" id="botalert_opt_custid" size="40" value="<?php  echo $optionarray_def['custid']; ?>" /> <a href="http://www.pramana.com/images/screenshot-3.png" target="_blank">How to get this?</a>
				<br />
				<!-- BotAlert authtoken -->
